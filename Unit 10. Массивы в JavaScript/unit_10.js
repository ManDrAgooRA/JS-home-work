...
let ar1 = [1, 2, 3, 4, 'str', true, false, 5, 6];
...
let ar2 = [1, 2, 3, 4, 'str', true, false, 5, 6];
...
// let ar6 =
let ar6 = ['Евгений', 'Близнецы', 20, 06];
...
function f16() {
    ...
    outEven.innerHTML = even;
    outOdd.innerHTML = odd;
}
...
function f17() {
    ...
    for (let i = 0; i < ar17.length; i++) {
        if (ar17[i] > 3) {
            ar17_1[ar17_1.length] = `${ar17[i]}`;
        }
    }

    let out = document.querySelector('.out-17');
    out.innerHTML = ar17_1.length;
}
